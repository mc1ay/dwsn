...
int mcu_function_respond_lfg(struct Node*, int, double*);
int mcu_function_scan_lfg_responses(struct Node*, int, double*);
int mcu_function_random_wait(struct Node*, int);
int mcu_function_lfgr_send_ack(struct Node*, int);
int mcu_function_lfgr_get_ack(struct Node*, int, double*);
