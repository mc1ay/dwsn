...
int mcu_function_main(struct Node*, int, int, int, int, int, int);
int mcu_function_scan_lfg(struct Node*, int, int, int, int, int);
int mcu_function_broadcast_lfg(struct Node*, int, int, double*, int);
...
int mcu_function_respond_lfg(struct Node*, int, int, double*, int);
